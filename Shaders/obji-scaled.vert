...
// Interface Output Block (Matches Fragment Shader input block)
out fData
{
    vec3 normal;
    vec3 position;
...
void main()
{
    ...
    frag.position = finalWorldPos;

    // 3. AUTOMATED INVERSE-TRANSPOSE NORMAL MATRIX CALCULATION
    // Build the dynamic structural orientation frame for this unique vertex segment
